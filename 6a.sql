...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2019 at 12:53 PM
...
SELECT cashier.name AS 'Cashier', product.name AS 'Product', category.name AS 'Category', product.price AS 'Price' FROM product 
